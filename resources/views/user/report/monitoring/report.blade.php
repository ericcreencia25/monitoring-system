          ...
          <div class="card-body p-0">
            <div class="card card-default" style="box-shadow: none;">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="inputClientCompany" style="margin-bottom: 0px;">FILES</label>
                  <div class="row">
                    <div class="col-md-10">
