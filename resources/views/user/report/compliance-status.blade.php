                        ...
                        <td colspan="3">
                            <div class="form-group">
                                <table class="table table-bordered table-hover" id="ECC-Conditionalities">
                                    ...
                                    <tbody>
                                        @include('user.report.law-and-citation.ecc')
                                    </tbody>
                                </table>
                            </div>
                        </td>
                        ...
                        <td colspan="3">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered table-hover" id="RA-6969-table">
                                    ...
                                    <tbody>
                                        @include('user.report.law-and-citation.ra6969')
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <td colspan="3">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered table-hover" id="RA-8749-table">
                                    ...
                                    <tbody>
                                        @include('user.report.law-and-citation.ra8749')
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <td colspan="3">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered table-hover" id="RA-9003-table">
                                    ...
                                    <tbody>
                                        @include('user.report.law-and-citation.ra9003')
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <td colspan="3">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered table-hover" id="RA-9275-table">
                                    ...
                                    <tbody>
                                        @include('user.report.law-and-citation.ra9275')
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <td colspan="3">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered table-hover" id="PCOA-table">
                                    ...
                                    <tbody>
                                        @include('user.report.law-and-citation.pcoa')
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <td colspan="3">
                            ...
                            <div class="form-group">
                                <table class="table table-bordered table-hover" id="SMR-table">
                                    ...
                                    <tbody>
                                        @include('user.report.law-and-citation.smr')
                                    </tbody>
                                </table>
                            </div>
                        </td>
                            ...
                            <div class="col-3">
                                ...
                                <select class="form-control rounded-0" id="polutan-degree-add">
                                    ...
                                    <option value="row2">Nitrogen Dioxide Emissions
                                        (mg/Ncm)</option>
                                    <option value="row3">Carbon Monoxide Emissions (mg/Ncm)
                                    </option>
